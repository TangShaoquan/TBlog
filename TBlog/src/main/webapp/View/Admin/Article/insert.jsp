...
<rapid:override name="header-style">
    <link rel="stylesheet" href="../../plugin/editormd/css/style.css" />
...
<rapid:override name="content">
    ...
    <form class="layui-form"  method="post" id="myForm" action="/admin/article/insertSubmit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="background-color: #fbfbfb; border: 2px solid #e6e6e6; border-radius:10px;padding: 0;">
                <input type="text" name="articleTitle" lay-verify="title" id="title" autocomplete="off" placeholder="请输入标题" class="layui-input">
            </div>
        </div>

        <div id="SummaryTestArea" style="padding: 0;">
            <div><label class="layui-form-label">摘要 <span style="color: #FF5722; ">*</span></label></div>
            <div class="layui-form-item" style="background-color: #fbfbfb; border: 2px solid #e6e6e6; border-radius:10px;padding: 0;">
                    <%--                文章摘要--%>
                <textarea name="articleSummary" required lay-verify="required" placeholder="请输入文章摘要（不大于150字）" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">正文 <span style="color: #FF5722; ">*</span></label>
            <div id="layout">
                <div id="test-editormd" class="editormd" style="background-color: #fbfbfb; border: 2px solid #e6e6e6; border-radius:5px;padding: 0;">
                    <textarea style="display:none;"  class="editormd-markdown-textarea" name="test-editormd-markdown-doc" lay-verify="content" id="editormd">[TOC]
...
```
                    ...
                    <textarea style="display:none;" class="editormd-html-textarea" name="articleContent" id="editormdhtml"></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" lay-filter="demo1" id="layui-btn">立即提交</button>
...
<rapid:override name="footer-script">
    ...
    <script src="../../plugin/editormd/js/jquery.min.js"></script>
